...
export default function QuotationGenerator({ 
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      style.textContent = `
        ...
        [ref="invoiceRef"], [id*="bill-preview"] { 
      ...
      allElements.forEach(el => {
        ...
        // Remove any max-height constraints that might cut content
      ...
      const opt = {
        ...
        html2canvas: { 
          ...
          onclone: (clonedDoc: Document) => {
            ...
            const clonedElement = clonedDoc.querySelector('[ref="invoiceRef"]') || clonedDoc.getElementById('bill-preview');
            if (clonedElement) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 flex justify-center">
      <div className="w-full max-w-4xl" ref={invoiceRef} style={{ pageBreakInside: 'avoid' }}>
